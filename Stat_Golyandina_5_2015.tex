...
\textbf{Задание}: построить критерий для распределений Бернулли и Пуассона.
...
\textbf{Задание}: построить хорошие доверительные интервалы, решив квадратное уравнение.
