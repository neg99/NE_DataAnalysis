...
\[
r^2=\sum_{i=1}^{K}\sum_{j=1}^{S}\frac{\left(p_{ij}-p_{i}p_{j}\right)^{2}}{p_{i}p_{j}}
\]
...
\section{Оценка коэффициента корреляции}
...
\chapter{Происхождение и сравнение других мер зависимости}
