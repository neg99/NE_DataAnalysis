...
\end{cases}
\]
 Вероятность ошибки первого рода равно $\a$, что соответствует определению критерия.
...
\section{Использование $\SE$ для построения доверительных интервалов}
...
\chapter{Критерии согласия с видом распределения}
\section{Критерий $\chi^{2}$ согласия с видом распределения}
